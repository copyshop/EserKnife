                ...
                if (StringUtils.isNotBlank(esCluster.getUserName())) {
                    ...
                    if (customUser != null) {
                        if (customUser.isAdmin() && clusterInfo != null) {
                            ...
                            httpClientConfig.defaultCredentials(customUser.getEsAccout(), customUser.getEsPwd());
                            key.append(customUser.getEsAccout());
                        } else {
                        ...
                        httpClientConfig.defaultCredentials(clusterInfo.getMonitorRoleName(), clusterInfo.getMonitorRolePwd());
                        key.append(clusterInfo.getMonitorRoleName());
                    }
                }

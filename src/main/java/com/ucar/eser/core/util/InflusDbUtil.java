...
public class InflusDbUtil {
	...
	public static Map<String, Object> query(QueryResult queryResult, Integer seriesIndex, Integer valRow,
			Integer indexVal) {
		Map<String, Object> map = new HashMap<String, Object>();
		String result = null;
		if (valRow != null && indexVal != null && queryResult != null) {
			result = queryResult.getResults().get(0).getSeries().get(seriesIndex).getValues().get(valRow).get(indexVal)
					.toString();

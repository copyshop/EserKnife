...
public class HealthAlarm extends KeyCallable<Boolean> {
	...
	private AlarmRuleService alarmRuleService = (AlarmRuleService) SpringInit.getApplicationContext()
			.getBean("alarmRuleServiceImpl");
	...
	public HealthAlarm(String key, String clusterName, String newResult, QueryResult oldResult,
			NodeCommonStatInfo nodeCommonStatInfo) {
		super(key);
